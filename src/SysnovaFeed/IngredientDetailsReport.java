 ...
 * @author root
 */
public class IngredientDetailsReport extends javax.swing.JFrame {


    /**
     * Creates new form ingredientsAll
     */
    public  IngredientDetailsReport() {
    ...
    public void reportDesigntWork() {
        ...
        try {
            ingredientList=sqlManager.getingredientRepdata();
            ingredientComboPanel();
    ...
    public void ingredientComboPanel() {
        
        DefaultComboBoxModel model = (DefaultComboBoxModel) ingredientComboBox.getModel();
        // removing old data
        model.removeAllElements();

        for(int i=0;i<ingredientList.size();i++)
        {
                Vector line =(Vector) ingredientList.get(i);
                String name = (String) line.get(1);
                model.addElement(name);
        }
        ingredientComboBox.setModel(model); 
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Ingredient Details Report");
        ...
        ingredientComboBox.setBackground(new java.awt.Color(255, 255, 255));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(ingredientComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 298, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(37, 37, 37))
        );
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
      int unit_Index=ingredientComboBox.getSelectedIndex();
        Vector ingredient =(Vector) ingredientList.get(unit_Index);
        ...
        try {
            ...
            report.igredientDetailsReport(ingredientID);
            this.dispose();
